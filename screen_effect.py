import pygame, time, piece, math, settings
def screen_effect(effect):
    ...
    if effect == "rotate": 
        ...
        screen_surface.fill((255, 255, 255))  # 기존 화면 지우기
    ...
    if effect == "rotating": 
        ...
        # 회전 적용하기
        rotated_surface = pygame.transform.rotate(screen_copy, (((time.time()-piece.rotate_start)%360))*100)
